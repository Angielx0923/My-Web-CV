                ...
                <div class="profile-footer">
                    <div class="social-media-container" <?php if ( is_page( 'contact' ) ) : echo $socialmedia; endif; ?>>
                        <div class="social-media-container__link social-media-container__link--linkedin">
                            <a href="<?php echo get_theme_mod( 'alm_section_linkedin' ); ?>" class="fa fa-linkedin-square icon social-media-container__logo<?php if ( is_404() ) : echo $errorclass; endif; ?> social-media-container__logo--linkedin"></a>
                        </div>
                        <div class="social-media-container__link social-media-container__link--github">
                            <a href="<?php echo get_theme_mod( 'alm_section_github' ); ?>" class="fa fa-github icon social-media-container__logo<?php if ( is_404() ) : echo $errorclass; endif; ?> social-media-container__logo--github"></a>
                        </div>
                    </div>
                </div>
            </footer>
