                    ...
                    <div class="profile-content">
                        ...
                        <div class="bg-container" id="bg-profile" style="background-image:url(<?php echo get_theme_mod( 'alm_bg_img' ); ?>);">
                            ...
                            data-rellax-percentage=".8">
                                <h1 class="section-part ID-container__my-name"><?php echo get_theme_mod( 'alm_myname' ); ?></h1>
                                <p class="ID-container__job-title"><?php echo get_theme_mod( 'alm_slogan' ); ?></p>
                                <a href="<?php the_permalink( ALM_PERMALINK_ARCHIVE ); ?>" class="ID-container__projects-link"><?php echo get_theme_mod( 'alm_projects_link' ); ?></a>
                            </div>
                            <!-- PROFIL PICTURE -->
                ...
                <section class="profile__container profile__container--content container" id="profile">
                    ...
                    <div class="profile-footer">
                        <div class="social-media-container">
                            <a href="<?php echo esc_url(get_theme_mod( 'alm_section_linkedin' )); ?>" aria-label="LinkedIn" class="fa fa-linkedin-square icon social-media-container__logo social-media-container__logo--linkedin"></a>

                            <?php $alm_download_active = get_theme_mod( 'alm_download_active', false ); 
			
                                if ( $alm_download_active ) :
                                ?>
                                    <a href="<?php echo get_theme_mod( 'alm_download_upload' ); ?>" aria-label="Download resume" class="social-media-container__link social-media-container__link--download btn-download" download>
                                ...
                                <?php endif; ?>
                                <a href="<?php echo esc_url(get_theme_mod( 'alm_section_github' )); ?>" aria-label="GitHub" class="fa fa-github icon social-media-container__logo social-media-container__logo--github"></a>
